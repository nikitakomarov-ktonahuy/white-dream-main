...
/datum/game_mode/nuclear/generate_report()
	return "Один из торговых путей ЦК был недавно разломлен рейдом мародёров Горлекс.	\
	Они летели только за одним кораблём - содержащим ядерную бомбу, бесполезную без кода и диска. \
	Пока код скорее всего был найден за считанные минуты,	\
	единственный диск который может активировать эту бомбу находится на вашей станции.	\
	Удостоверьтесь что он всегда под защитой, и оставайтесь на готове для отражения возможной атаки мародёров."
